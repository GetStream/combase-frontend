...
import { AddImageIcon, Avatar, Box, Container, LabelledToggle, ListDetailSection, Modal, Text, TextInput } from '@combase.app/ui';
				...
				{formik => (
					<Container paddingY={6} maxWidth={22}>
						...
						<ListDetailSection title="Security" description="Configure the default security settings at the Organization level, to be applied to all agent accounts.">
							<LabelledToggle name="security.global2Fa" onBlur={formik.handleBlur} onChange={formik.handleChange} checked={formik.values.security.global2Fa} title="Two Factor Authentication">
