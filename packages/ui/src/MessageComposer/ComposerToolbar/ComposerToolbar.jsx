		...
		<Wrapper>
			...
			<Root marginTop={4} paddingBottom={4}>
				...
				<Box display="flex" alignItems="center">
					{
						editMode ? (
							<ActionGroup height={4} marginRight={4}>
								<Button color="error" size="xs" variant="flat" onClick={clearEditingState}>
					...
					<ActionGroup gapLeft={3}>
						...
						<IconButton color={disabled || !text ? "disabled" : "primary"} fillAlpha={!text ? 0.2 : 1} disabled={!text} icon={SendIcon} onClick={(_, e) => handleSubmit(e)} size={4} />
					</ActionGroup>
				</Box>
			</Root>
		</Wrapper>
